...
```{r continuous_analysis, echo=FALSE, message=FALSE, warning=FALSE}
...
names(robotic_dic)[10] <- "e2"
names(robotic_dic)[11] <- "e1"
...
tt_leak <- table_or(analysis = leak_or, nstudies = 3, 
                    int = "Left robotic (n)", comp = "Right robotic (n)",
...
title1 <- c('', paste0('Left robotic (n/N)'),
            paste0('Right robotic (n/N)'),
